    ...
    public class InvoiceService : IInvoiceService
    {
        ...
        public async Task<InvoiceDTO?> GenerateMonthlyInvoicesMinimalAsync()
        {
            try
            {
                ...
                var sub = activeSubs.OrderByDescending(s => s.StartDate).First();

                // Calculate total months from past subscriptions
            ...
            {
                _logger.LogError(ex, "Error generating monthly invoice.");
                throw;
            }
        }
